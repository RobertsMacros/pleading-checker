        ...
        For i = 1 To Len(paraText)
            ...
            Select Case charCode
                ...
                Case CURLY_DOUBLE_OPEN, CURLY_DOUBLE_CLOSE, STRAIGHT_DOUBLE
                    ...
                    Set issue = CreateIssueDict(RULE_NAME, locStr, "Outer quotation marks should use single quotation marks.", "Use single quotation marks instead of double quotation marks.", rangeStart, rangeEnd, "warning", False)
                    issues.Add issue
            End Select
        Next i
