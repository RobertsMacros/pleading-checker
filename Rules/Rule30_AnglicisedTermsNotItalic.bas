Attribute VB_Name = "Rule30_AnglicisedTermsNotItalic"
' ============================================================
' Rule30_AnglicisedTermsNotItalic.bas
...
' ════════════════════════════════════════════════════════════
Public Sub RunAnglicisedTermsNotItalic()
    If ActiveDocument Is Nothing Then
        MsgBox "Please open a document first.", vbExclamation, "Anglicised Terms Not Italic"
        Exit Sub
    End If
    ...
    MsgBox "Found " & issues.Count & " issue(s).", _
           vbInformation, "Anglicised Terms Not Italic"
End Sub
