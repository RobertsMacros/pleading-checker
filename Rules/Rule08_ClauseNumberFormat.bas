...
' ════════════════════════════════════════════════════════════
Public Sub RunClauseNumberFormat()
    If ActiveDocument Is Nothing Then
        MsgBox "Please open a document first.", vbExclamation, "Clause Number Format"
        Exit Sub
    End If
    ...
    Set issues = Check_ClauseNumberFormat(doc)
    ...
    MsgBox "Found " & issues.Count & " issue(s).", _
           vbInformation, "Clause Number Format"
End Sub
