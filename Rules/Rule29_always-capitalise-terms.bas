Attribute VB_Name = "Rule29_always_capitalise_terms"
' ============================================================
' Rule29_always-capitalise-terms.bas
...
Private Sub CheckTermInParagraph(doc As Document, _
    ...
    Do While pos > 0
        ...
        Set issue = CreateIssueDict(RULE_NAME, locStr, "Term should be capitalised in the approved form.", "Use '" & correctForm & "'.", matchStart, matchEnd, "warning", False)
        issues.Add issue
