Attribute VB_Name = "Rule20_FootnoteIntegrity"
' ============================================================
' Rule20_FootnoteIntegrity.bas
...
' ════════════════════════════════════════════════════════════
Public Sub RunFootnoteIntegrity()
    If ActiveDocument Is Nothing Then
        MsgBox "Please open a document first.", vbExclamation, "Footnote Integrity"
        Exit Sub
    End If
    ...
    Set issues = Check_FootnoteIntegrity(doc)
    ...
    MsgBox "Found " & issues.Count & " issue(s).", _
           vbInformation, "Footnote Integrity"
End Sub
