...
' ════════════════════════════════════════════════════════════
Public Sub RunDateTimeFormat()
    If ActiveDocument Is Nothing Then
        MsgBox "Please open a document first.", vbExclamation, "Date Time Format"
        Exit Sub
    End If
    ...
    Set issues = Check_DateTimeFormat(doc)
    ...
    MsgBox "Found " & issues.Count & " issue(s).", _
           vbInformation, "Date Time Format"
End Sub
