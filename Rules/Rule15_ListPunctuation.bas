...
' ════════════════════════════════════════════════════════════
Public Sub RunListPunctuation()
    If ActiveDocument Is Nothing Then
        MsgBox "Please open a document first.", vbExclamation, "List Punctuation"
        Exit Sub
    End If
    ...
    Set issues = Check_ListPunctuation(doc)
    ...
    MsgBox "Found " & issues.Count & " issue(s).", _
           vbInformation, "List Punctuation"
End Sub
