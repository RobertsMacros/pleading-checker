Attribute VB_Name = "Rule32_SingleQuotesDefault"
' ============================================================
' Rule32_SingleQuotesDefault.bas
...
' ════════════════════════════════════════════════════════════
Public Sub RunSingleQuotesDefault()
    If ActiveDocument Is Nothing Then
        MsgBox "Please open a document first.", vbExclamation, "Single Quotes Default"
        Exit Sub
    End If
    ...
    MsgBox "Found " & issues.Count & " issue(s).", _
           vbInformation, "Single Quotes Default"
End Sub
